...
static const StoryOption STORY_OPTIONS[] = {
    ...
    {"Ask what happened to Norway?", 13, 255, STORY_COND_NONE},
    ...
    {"Share your secret stash of coffee", 22, 255, STORY_COND_HAS_COFFEE},
    ...
    {"\"Wait for me in my next shift.\"", 30, 255, STORY_COND_NONE},
    {"Attempt to hide from the AI", 26, 255, STORY_COND_NONE},
    {"Acceptance. Make the most of ur days", 30, 255, STORY_COND_NONE},
};
