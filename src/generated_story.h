...
static const StoryOption STORY_OPTIONS[] = {
    ...
    {"\"I am L-73, Leader Class. Just awakened.\"", 11, 255, STORY_COND_NONE},
    ...
    {"Continue to SCENE 19.", 19, 255, STORY_COND_NONE},
    ...
    {"Embrace the forbidden romance", 25, 255, STORY_COND_NONE},
...
static const StoryScene STORY_SCENES[] = {
    ...
    {5, "CONFIRMED IDENTITY", "IDENTITY CONFIRMED: SUBJECT L-73. The screen flashes. A compressed audio log plays: \"The Middle East exchange... the thermal bloom... the Gulf Stream has collapsed. We are activating AETHELRED. Welcome to the new Ice Age, L-73. Report to the Core.\"", 10, 2, 0},
    ...
    {19, "ASSIGNMENT", "Your awakening is logged. The AI Core flashes your duties. L-73 ASSIGNMENT: OPTIMIZE FUSION STABILIZER, SECTOR 7. DURATION: 1 YEAR. PREP FOR STASIS RETURN: YEAR 2143.", 35, 1, 0},
    ...
    {22, "COFFEE AND COMPLICITY", "The aroma of real coffee fills the sterile deck. Her eyes widen. \"This... this is contraband, L-73.\" She laughs, a rare, beautiful sound. You drink the bitter brew together.", 40, 2, STORY_FLAG_COFFEE},
    ...
    {24, "THE KISS", "The proximity and the crushing loneliness merge. You look at her, and she is the only other human that matters. Your lips meet. It is desperate and electric.", 43, 1, 0},
    ...
    {28, "IMPOSSIBLE CHOICES", "You find Elara in the hidden tunnel. \"When you wake up, I’ll be 32, L-73. And you... you’ll still be you. My whole youth will happen while you sleep.\"", 49, 2, 0},
